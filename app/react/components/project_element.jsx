        ...
        return (
            <ElementPanel title = {
                ...
                <div className="col-lg-10">
                  <Field name={`${this.props.element}.name`} component={CustomTextField} label="Name" validate={[ required ]} />
                </div>
                <div className="col-lg-2">
                  <Field name={`${this.props.element}.date_from`} component={CustomDatePicker} label="From"/>
                </div>
                <div className="col-lg-10">
                  <Field name={`${this.props.element}.page`} component={CustomTextField} label="Page"/>
                </div>
                <div className="col-lg-2">
